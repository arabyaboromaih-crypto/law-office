                      ...
                      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <div className="flex flex-wrap items-center gap-1.5">
                          ...
                          {(c.isInvestigationActive || c.status === 'قيد التحقيق') && (
                            <span className="bg-amber-500/15 text-amber-950 text-[10px] px-2.5 py-1 rounded-lg font-black flex items-center gap-1 border border-amber-500/30 animate-pulse">
                    ...
                    <div className="border-t border-slate-150 pt-4 flex flex-col gap-2.5">
                      {(c.isInvestigationActive || c.status === 'قيد التحقيق') && (
                        <button
                          ...
                          className="w-full py-2.5 px-3 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-950 text-xs font-black rounded-xl transition-all duration-150 flex items-center justify-center gap-1.5 cursor-pointer shadow-3xs"
                        >
