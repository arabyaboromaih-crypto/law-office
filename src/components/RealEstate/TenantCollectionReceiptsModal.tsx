  ...
  <div class="receipt-container">
    <div class="header">
      <div class="header-logo">
        ...
        <p>قسم الإدارة العقارية وتحصيل الإيجارات • هاتف المؤسسة: 01143472682</p>
      </div>
    ...
    <div class="footer-note">
      مؤسسة رميح للمحاماة والاستشارات القانونية • هاتف المؤسسة: 01143472682 • يُعتبر هذا السند إيصال سداد مالي رسمي لا يُعتد به إلا إذا كان موقعاً ومختوماً. تم الإصدار إلكترونياً عبر منظومة رميح القانونية.
    </div>
  </div>
</body>
</html>`;
