...
<body>
  <div class="page-container">
    ...
    <div class="header-branding">
      <div class="brand-logo-title">
        ...
        <div>
          ...
          <div class="firm-sub">قطاع الإدارة العقارية والتحصيل والخدمات المالية والتوثيق • هاتف المؤسسة: 01143472682</div>
        </div>
      </div>
    ...
    <div class="report-footer">
      مؤسسة رميح للمحاماة والاستشارات القانونية • هاتف المؤسسة: 01143472682 • وثيقة إلكترونية موثقة صادرة عن منظومة مؤسسة رميح للمحاماة - جميع الحقوق محفوظة © ${new Date().getFullYear()}
    </div>
