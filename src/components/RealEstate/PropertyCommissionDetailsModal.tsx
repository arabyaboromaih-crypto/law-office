...
interface PropertyCommissionDetailsModalProps {
  ...
  onOpenReceipts?: (group: CommissionPropertySummaryGroup) => void;
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {onOpenReceipts && (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 border border-purple-500/40 text-xs font-black transition-all cursor-pointer flex items-center gap-1.5 shadow-sm hover:scale-[1.02] active:scale-95"
