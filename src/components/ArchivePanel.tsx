...
export default function ArchivePanel({ 
  ...
  useBackHandler(showAddArchiveModal, () => setShowAddArchiveModal(false));
  useBackHandler(showAddCompanyArchiveModal, () => setShowAddCompanyArchiveModal(false));
  useBackHandler(!!selectedCaseProfile, () => setSelectedCaseProfile(null));
  useBackHandler(!!selectedCompanyProfile, () => setSelectedCompanyProfile(null));
  useBackHandler(!!deleteCaseTarget, () => setDeleteCaseTarget(null));
              ...
              <div key={c.id} className="bg-white border border-slate-200 rounded-xl p-5 shadow-3xs flex flex-col justify-between space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-slate-600 space-y-1.5 bg-slate-50 p-3 rounded-lg">
                    <p><strong>الموكل:</strong> {c.clientName || 'غير محدد'}</p>
                    <p><strong>الخصم:</strong> {c.opponent?.name || 'غير محدد'}</p>
                  </div>
