...
import { User as UserType, UserPermissions, getDefaultPermissionsForRole } from '../types';
...
export default function InitializationScreen({ onInitializationComplete }: InitializationScreenProps) {
  ...
  const handleSaveDirectorDetails = (e: React.FormEvent) => {
    ...
    const adminPermissions: UserPermissions = getDefaultPermissionsForRole('admin');
