...
import { Case, HearingSession, PaymentReceipt, CaseClient, Opponent, User as AppUser, CaseFile, Client, LitigationDegree, DetentionRenewalRecord, InvestigationProcedure } from '../types';
