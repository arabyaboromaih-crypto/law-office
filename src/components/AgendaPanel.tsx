        ...
        <html>
          <head>
            ...
            <style>
              ...
              .seq-col { text-align: center; font-weight: bold; background-color: #f8fafc; width: 35px; }
            </style>
          </head>
          <body>
            <div class="header">
            ...
            <table>
              ...
              <tbody>
                ${sortedPrintData.length === 0 ? `<tr><td colspan="8" style="text-align:center;">لا توجد جلسات مدرجة في هذا الجدول الزمني.</td></tr>` : 
