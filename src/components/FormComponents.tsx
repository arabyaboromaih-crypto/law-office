      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden p-3 sm:p-4 lg:p-6" dir="rtl">
          ...
          >
            ...
            {/* Sub-Header (e.g. Navigation Stepper / Action bar placed closely and symmetrically below title) */}
            {subHeader && (
              <div className="border-b border-slate-200/80 bg-slate-50/95 px-3 sm:px-5 py-1.5 shrink-0 z-10">
                {subHeader}
              </div>
            )}
