...
export default function SettingsPanel({ 
  ...
  const [generalDirectorPhone, setGeneralDirectorPhone] = useState('01143472682');
  ...
  const [officeWhatsapp, setOfficeWhatsapp] = useState('+201143472682');
