  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newSess: HearingSession = {
        ...
        court: finalCourt || (isDetention ? (detentionAuthority || 'النيابة العامة') : 'غير محدد'),
        circuit: circuit || (isDetention ? 'غرفة المشورة / التجديدات' : 'غير محدد'),
        ...
        detentionRenewalId: isDetention ? renId : undefined
      };
      ...
      await onAddSession(newSess, {
        ...
        renewalId: isDetention ? renId : undefined
      });
