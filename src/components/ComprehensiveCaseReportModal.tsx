          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                قضية رقم <span className="text-amber-400 font-bold">{caseData.caseNumberFirstInstance}</span> لسنة {caseData.caseYearFirstInstance} - {caseData.court}
              </p>
            </div>
          </div>
            ...
            <div className="border border-slate-200 rounded-xl overflow-hidden shadow-xs bg-white">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 divide-x divide-x-reverse divide-slate-200 bg-slate-50 text-center">
                <div className="p-2.5">
                  ...
                  <div className="font-extrabold text-slate-900">{caseData.courtFirstInstance || caseData.court} - د/{caseData.circuitFirstInstance || caseData.circuit}</div>
                </div>
                <div className="p-2.5">
                ...
                <div className="p-2.5">
                  ...
                  <div className="font-extrabold text-amber-700">{caseData.type} ({caseData.degree})</div>
                </div>
                <div className="p-2.5">
