...
export const initialSessions: HearingSession[] = [
  ...
  {
    id: 'session-detention-demo-1',
    caseId: 'case-1',
    caseNumber: '14205',
    caseYear: '2025',
    clientName: 'عصام رأفت أبو الوفا',
    opponentName: 'النيابة العامة',
    court: 'محكمة الجنايات (غرفة المشورة)',
    circuit: 'الدائرة 7 تجديدات وتحقيق',
    type: 'جنح',
    date: '2026-08-05',
    time: '09:00',
    subject: 'جلسة تجديد حبس احتياطي (تجديد 45 يوماً - غرفة المشورة)',
    status: 'pending',
    assignedLawyerId: 'user-lawyer-1',
    assignedLawyerName: 'الأستاذ محمود الشافعي',
    notes: 'حضور جلسة تجديد الحبس احتياطياً للمتهم أمام محكمة الجنايات بغرفة المشورة، وتقديم مذكرة بطلب إخلاء سبيله بأي ضمان مالي أو عيني.',
    isDetentionRenewal: true,
    detentionAuthority: 'تجديد غرفة المشورة',
    detentionDurationDays: 45
  }
];
