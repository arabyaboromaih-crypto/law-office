...
export default function App() {
  ...
  const handleUpdateCase = async (updated: Case) => {
    ...
    try {
      ...
      const newCaseAutoSessionIds = new Set(newCaseAutoSessions.map(s => s.id));
      ...
      setSessions(prev => {
        ...
        return [...remaining, ...newCaseAutoSessions];
      });
      ...
      // Delete obsolete auto sessions for this case from Firestore
        ...
        if (parentCase) {
          ...
          if (!isDetention && !isExpert && updated.nextHearingDate && updated.nextHearingDate !== updated.date) {
            ...
            if (!hasPendingNext) {
              ...
              const pendingSessionsToDel = sessions.filter(s => s.caseId === updated.caseId && s.status === 'pending' && s.id !== updated.id && s.date === updated.nextHearingDate);
