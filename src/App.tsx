  ...
  return (
    <div className="h-screen min-h-screen overflow-hidden bg-[#0d121f] flex flex-col font-sans text-slate-100 selection:bg-amber-500 selection:text-slate-950 overflow-x-clip relative" dir="rtl">
      ...
      <div className="flex-1 flex flex-col lg:flex-row relative z-10 h-[calc(100vh-56px)] md:h-[calc(100vh-64px)] overflow-hidden">
        ...
        <aside className={`fixed inset-y-0 right-0 z-[50] w-80 sm:w-84 p-4 flex flex-col space-y-4 transition-transform duration-300 transform lg:hidden ${isSidebarOpenMobile ? 'translate-x-0' : 'translate-x-full'} overflow-hidden select-none`}>
          ...
          <div className="flex items-center justify-between border-b border-[#1c2e4a]/70 pb-3 relative z-10 pt-1">
            <div className="flex-1 flex items-center justify-center gap-2">
              <span className="w-8 h-[1px] bg-gradient-to-r from-transparent via-amber-400/60 to-amber-400"></span>
              <span className="text-amber-400 font-extrabold text-xs tracking-widest flex items-center gap-1.5">
                <span className="text-[9px] text-amber-400/90">◇</span>
                <span>أقسام وميزات المكتب</span>
                <span className="text-[9px] text-amber-400/90">◇</span>
              </span>
              <span className="w-8 h-[1px] bg-gradient-to-l from-transparent via-amber-400/60 to-amber-400"></span>
            </div>
            <button 
              onClick={() => setIsSidebarOpenMobile(false)}
          ...
          <div className="space-y-2.5 flex-1 overflow-y-auto pr-0.5 relative z-10 scrollbar-none">
            {sidebarMenuItems.map((item) => {
              ...
              let btnClass = "w-full p-2.5 sm:p-3 rounded-2xl flex items-center justify-between gap-3 text-right transition-all duration-200 border relative overflow-hidden group active:scale-[0.98] cursor-pointer ";
              
              if (isLocked) {
                btnClass += "bg-slate-900/30 border-slate-800/30 text-slate-600 cursor-not-allowed opacity-50";
              } else if (isActive) {
                btnClass += "bg-gradient-to-r from-[#12223a]/90 via-[#1a2d4c]/90 to-[#0e1b2e]/95 border-amber-400/90 shadow-[0_0_20px_rgba(245,158,11,0.25)] scale-[1.01]";
              } else {
                btnClass += "bg-[#0d1829]/65 hover:bg-[#122138]/90 border-[#1c2e4a]/70 hover:border-amber-500/50 shadow-md hover:shadow-lg";
              }
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-11 h-11 rounded-full border ${item.badgeBorder} ${item.badgeBg} ${item.badgeText} ${item.badgeShadow} flex items-center justify-center shrink-0 transition-transform duration-300 group-hover:scale-105`}>
                    <IconComponent className="w-5 h-5" />
                  </div>

                  {/* Section Title & Description in Middle */}
                  <div className="flex-1 text-right min-w-0 pr-1">
                    <span className={`block text-xs sm:text-sm font-black leading-tight truncate ${isActive ? 'text-amber-300' : 'text-slate-100'}`}>
                      {item.title}
                    </span>
                    <span className="block text-[10px] font-medium text-slate-400 mt-0.5 leading-tight truncate">
                      {item.desc}
                    </span>
                  </div>
                  ...
                  <div className="shrink-0 flex items-center justify-center pl-1">
                    <ChevronLeft className={`w-4 h-4 transition-transform duration-200 group-hover:-translate-x-1 ${isActive ? 'text-amber-400' : 'text-slate-500 group-hover:text-slate-300'}`} />
                  </div>
                </button>
              );
            })}
          ...
          <div className="mt-auto p-3.5 rounded-2xl bg-gradient-to-br from-[#0f1e35]/90 via-[#0c182a]/95 to-[#07101c]/95 border border-amber-500/40 shadow-xl relative overflow-hidden backdrop-blur-md">
            {/* Scales Watermark */}
            <div className="absolute -left-2 -bottom-2 opacity-[0.08] pointer-events-none select-none">
              <Scale className="w-20 h-20 text-amber-400" />
            </div>

            <div className="flex items-center gap-3 relative z-10">
              <div className="w-12 h-12 rounded-full border-2 border-amber-400/80 bg-gradient-to-br from-amber-500/30 via-amber-600/20 to-amber-950/60 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(245,158,11,0.3)]">
                <UserIcon className="w-6 h-6 text-amber-300" />
              </div>
              <div className="text-right flex-1 min-w-0">
                <span className="text-[10px] text-amber-400 font-extrabold tracking-wide block">المدير العام ومدير المؤسسة</span>
                <span className="text-xs sm:text-sm font-black text-white truncate block mt-0.5">{currentUser?.fullName || 'الأستاذ عربي رميح'}</span>
              </div>
            </div>

            <div className="flex items-center justify-center gap-4 border-t border-slate-800/80 pt-2 mt-2.5 text-slate-400 text-xs relative z-10">
        ...
        <aside className={`hidden lg:flex flex-col border-l border-[#1c2e4a]/60 p-3 shrink-0 transition-all duration-300 ${isSidebarCollapsed ? 'w-20' : 'w-64 sm:w-72'} space-y-3 overflow-hidden select-none relative h-full`}>
          ...
          {!isSidebarCollapsed && (
            <div className="flex items-center justify-center gap-2 border-b border-[#1c2e4a]/70 pb-2.5 relative z-10 pt-1">
              <span className="w-6 h-[1px] bg-gradient-to-r from-transparent via-amber-400/60 to-amber-400"></span>
              <span className="text-amber-400 font-extrabold text-xs tracking-wider flex items-center gap-1.5">
                <span className="text-[9px] text-amber-400/90">◇</span>
                <span>أقسام وميزات المكتب</span>
                <span className="text-[9px] text-amber-400/90">◇</span>
              </span>
              <span className="w-6 h-[1px] bg-gradient-to-l from-transparent via-amber-400/60 to-amber-400"></span>
            </div>
          )}

          {/* Navigation Links Area */}
          <div className="space-y-2 flex-1 overflow-y-auto pr-0.5 select-none relative z-10 scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent">
            {sidebarMenuItems.map((item) => {
              // Check permissions
              if (item.permissionKey && (!currentUser?.permissions || !(currentUser.permissions as any)[item.permissionKey])) {
                return null;
              ...
              if (isSidebarCollapsed) {
                let colBtnClass = "w-full h-11 rounded-full flex items-center justify-center transition-all duration-200 relative group cursor-pointer border ";
                ...
                return (
                  ...
                  >
                    <IconComponent className={`w-5 h-5 ${isActive ? item.badgeText : ''}`} />
                  </button>
                );
              }

              // Expanded desktop view
              let btnClass = "w-full p-2.5 rounded-2xl flex items-center justify-between gap-2.5 text-right transition-all duration-200 border relative overflow-hidden group cursor-pointer active:scale-[0.98] ";

              if (isLocked) {
                btnClass += "bg-slate-900/30 border-slate-800/30 text-slate-600 cursor-not-allowed opacity-50";
              } else if (isActive) {
                btnClass += "bg-gradient-to-r from-[#12223a]/90 via-[#1a2d4c]/90 to-[#0e1b2e]/95 border-amber-400/90 shadow-[0_0_20px_rgba(245,158,11,0.22)] scale-[1.01]";
              } else {
                btnClass += "bg-[#0d1829]/65 hover:bg-[#122138]/90 border-[#1c2e4a]/70 hover:border-amber-500/50 shadow-md hover:shadow-lg";
              }
              ...
              return (
                <button
                  ...
                  className={btnClass}
                >
                  <div className={`w-10 h-10 rounded-full border ${item.badgeBorder} ${item.badgeBg} ${item.badgeText} ${item.badgeShadow} flex items-center justify-center shrink-0 transition-transform duration-300 group-hover:scale-105`}>
                    <IconComponent className="w-4.5 h-4.5" />
                  </div>

                  <div className="flex-1 text-right min-w-0 pr-0.5">
                    <span className={`block text-xs font-black leading-tight truncate ${isActive ? 'text-amber-300' : 'text-slate-100'}`}>
                      {item.title}
                    </span>
                    <span className="block text-[9.5px] font-medium text-slate-400 mt-0.5 leading-tight truncate">
                      {item.desc}
                    </span>
                  </div>

                  <div className="shrink-0 flex items-center justify-center pl-0.5">
                    <ChevronLeft className={`w-3.5 h-3.5 transition-transform duration-200 group-hover:-translate-x-1 ${isActive ? 'text-amber-400' : 'text-slate-500 group-hover:text-slate-300'}`} />
                  </div>
                </button>
              );
            })}
          ...
          {!isSidebarCollapsed && (
            <div className="p-3 rounded-2xl bg-gradient-to-br from-[#0f1e35]/90 via-[#0c182a]/95 to-[#07101c]/95 border border-amber-500/40 shadow-xl relative overflow-hidden backdrop-blur-md mt-auto">
              <div className="flex items-center gap-2.5 relative z-10">
                <div className="w-10 h-10 rounded-full border-2 border-amber-400/80 bg-gradient-to-br from-amber-500/30 via-amber-600/20 to-amber-950/60 flex items-center justify-center shrink-0 shadow-[0_0_12px_rgba(245,158,11,0.3)]">
                  <UserIcon className="w-5 h-5 text-amber-300" />
                </div>
                <div className="text-right flex-1 min-w-0">
                  <span className="text-[9px] text-amber-400 font-extrabold tracking-wide block">المدير العام ومدير المؤسسة</span>
                  <span className="text-xs font-black text-white truncate block mt-0.5">{currentUser?.fullName || 'الأستاذ عربي رميح'}</span>
                </div>
              </div>
            </div>
          )}
